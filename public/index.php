    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:25px; margin-top: 1% !important;">DentalRoute Inc.
                    ...
                    <div class="col-sm-2 d-none d-lg-block appoint">
                        <a class="btn btn-success" href="pages/user-login.php">Book an Appointment</a>
                    </div>
                </div>
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Book Your Dental Appointment in Cebu – Fast, Easy & Hassle-Free!</h5>
                ...
                <div class="carousel-item active">
                    <img class="d-block w-100" src="assets/images/slider/slider_5.jpg" alt="Third slide">
                      <div class="carousel-cover"></div>
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Smile Brighter – Book a Dentist Near You Today!</h5>
  ...
  <!--  ************************* Logins ************************** -->
                ...
                <div class="row no-margin">
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                <h6>Patient Login</h6>
                                <a href="pages/user-login.php" target="_blank">
                    ...
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                <h6>Doctors login</h6>
                                <a href="pages/doctor" target="_blank">
                                    <button class="btn btn-success btn-sm">Click Here</button>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                ...
                                <a href="pages/admin" target="_blank">
                                    <button class="btn btn-success btn-sm">Click Here</button>
                                </a>
                            </div>
                        </div>
    ...
    <div class="col-lg-4 col-md-6">
        <div class="single-key">
            <i class="fas fa-tooth"></i> <!-- Dental Icon -->
            <h5>Dental</h5>
        </div>
    </div>
    ...
    <div class="col-lg-4 col-md-6">
        <div class="single-key">
            <i class="fas fa-teeth"></i> <!-- Orthodental Icon -->
            <h5>Orthodental</h5>
        </div>
    </div>
    ...
    <div class="col-lg-4 col-md-6">
        <div class="single-key">
            <i class="fas fa-teeth-open"></i> <!-- Periodontal Icon -->
            <h5>Periododental</h5>
        </div>
    </div>
    ...
    <div class="col-lg-4 col-md-6">
    <div class="single-key">
        <i class="fas fa-teeth"></i> <!-- Better Teeth Check-up Icon -->
        <h5>Teeth Check-up</h5>
        </div>
    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-key">
                       <i class="fas fa-user-md"></i> 
                        <h5>Dental Professional Team in Cebu</h5>
                    </div>
                </div>
...
?>
    ...
    <p><?php  echo $row['PageDescription'];?>.</p><?php } ?>
        ...
        <div class="gallery-filter d-none d-sm-block">
            ...
            <button class="btn btn-default filter-button" data-filter="hdpe">Orthodental</button>
            <button class="btn btn-default filter-button" data-filter="sprinkle">Pediatric Dentist</button>
            <button class="btn btn-default filter-button" data-filter="spray"> Periodentist</button>
            <button class="btn btn-default filter-button" data-filter="irrigation">Endododentist</button>
        </div>
        <br/>
...
?>
    ...
    <div class="copy">
            <div class="container">
                <center>© 2025 BSIT 4</center>
        <center>Made with Love by Sir Chyll's Student</center> 
        <br>
