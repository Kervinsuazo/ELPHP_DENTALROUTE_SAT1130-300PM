...
if (strlen($_SESSION['id'] == 0)) {
    ...
    // API handling
    if (isset($_GET['api']) && $_GET['api'] == 'appointment') {
        // Define allowed methods
        $method = $_SERVER['REQUEST_METHOD'];

        switch ($method) {
            case 'GET':
                // Fetch appointment history via API
                ...
                while ($row = mysqli_fetch_array($sql)) {
                    $appointments[] = [
                        ...
                        'consultancy_fee' => $row['consultancyFees'],
                        'appointment_date_time' => $row['appointmentDate'] . ' / ' . $row['appointmentTime'],
                        'appointment_creation_date' => $row['postingDate'],
